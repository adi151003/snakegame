...
def game_finished():
    ...
    TextSurf, TextRect = text_objects("*** Game Over .Thanks for playing ***", largeText, (255,255,255))
...
def play():
    ...
    while not game_over:
        ...
        TextSurf, TextRect = text_objects("Snake Game by ADITYA", smallText, (0,0,0))     #display snake game
